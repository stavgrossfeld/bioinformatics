...
def main(filename):
    ...
    cmd_samtools_view = "samtools view /Users/stav/Desktop/bam_split/01_sample.bam | head"
    #samtools_output = subprocess.Popen(cmd_samtools_view, shell=False)
    # for line in tqdm(samtools_output, number_of_lines):
    #    print(line)

    subprocess.call([cmd_samtools_view], shell=False)
...
if __name__ == "__main__":
    ...
    filename = sys.argv[1] or "~Desktop/bam_split/01_sample.bam"
    main(filename)
